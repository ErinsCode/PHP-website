...
$sneaky = htmlentities($_POST['sneaky']);
$name = htmlentities($_POST['PlanetName']);
$posx = htmlentities($_POST['PosX']);
$posy = htmlentities($_POST['PosY']);
$posz = htmlentities($_POST['PosZ']);
$desc = htmlentities($_POST['Desc']);
$faction = htmlentities($_POST['Alignment']);
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="PosX" name="PosX" type="text" placeholder="0" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="PosY" name="PosY" type="text" placeholder="0" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="PosZ" name="PosZ" type="text" placeholder="0" class="form-control input-md">
  <span class="help-block">Must be a positive integer</span>  
  </div>
</div>
