...
require_once 'DataBaseConnection.php';  //load it once, if it doesn't load let it crash
...
echo "<br><h2>Making some visitable</h2><br><br>";
...
echo "<br>This is a table of all the planets<br>";

$search = "SELECT * FROM CSIS2440.Planets Order by PlanetName";

$return = $con->query($search);  //not true false
